...
public class EventOverdueAdapter extends RecyclerView.Adapter<EventOverdueAdapter.EventViewHolder> {
    ...
    public EventOverdueAdapter(Context mCtx, List<EventItemDTO> eventList) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(EventViewHolder holder, int position) {
        ...
        EventItemDTO event = eventList.get(position);
